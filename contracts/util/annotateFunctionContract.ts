...
export const annotateFunctionContract = new Contract<typeof annotateFunction>()
    ...
    .suchThat("the displayName attribute contains the annotation", ReturnValueCheckTestData.annotateFunctionDefault)
    ...
    .suchThat("the displayName attribute contains the annotation", ReturnValueCheckTestData.annotateFunctionGetter)
