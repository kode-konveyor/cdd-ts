...
import { getContractEmpty, getContractParametersSet } from "./ContractTestdata"
...
export const IfcalledWithContract = new Contract<typeof ifCalledWithFunction>()
    ...
    .thenReturn("if the current run was not empty, it is put to the current case",getContractParametersSet())
